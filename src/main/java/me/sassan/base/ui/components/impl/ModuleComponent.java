...
public class ModuleComponent extends Component {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        int bgColor = isMouseOver(mouseX, mouseY) ? 0xFF292929 : 0xFF1F1F1F;
        RenderUtils.drawRect(x, y, width, height, bgColor);
        RenderUtils.drawString(Minecraft.getMinecraft().fontRendererObj, module.getName(), x + 6,
                (int) (y + (float) Minecraft.getMinecraft().fontRendererObj.FONT_HEIGHT / 2 + 4),
                module.isEnabled() ? 0xFFFF4F4F : -1);
    }
