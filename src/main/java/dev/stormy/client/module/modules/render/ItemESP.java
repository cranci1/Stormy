...
public class ItemESP extends Module {
    private static TickSetting renderIron;
    private static TickSetting renderGold;

    public ItemESP() {
        super("ItemESP", ModuleCategory.Render, 0);
        this.registerSetting(renderIron = new TickSetting("Render Iron", true));
        this.registerSetting(renderGold = new TickSetting("Render Gold", true));
    }
    ...
    public void onRender(RenderWorldEvent e) {
        ...
        if (!itemsMap.isEmpty()) {
            float renderPartialTicks = mc.timer.renderPartialTicks;
